    ...
    return (
        <div className="w-full flex items-center flex-wrap justify-center gap-10 mt-40 mb-30">
            <div className="grid gap-4 w-60">
                ...
                <div>
                    <h2 className="text-center text-white text-base font-semibold leading-relaxed pb-1">There's no flashcard to preview</h2>
                    <p className="text-center text-white text-sm font-normal leading-snug pb-4">Start generating your flashcards above or see your <a href="/user_cards" className="text-blue-400">cards</a >. </p>
